        ...
        <div class="row items-push">
            ...
            <div class="col-sm-4 text-right hidden-xs">
                <ol class="breadcrumb push-10-t">
                    ...
                    <li class="link-effect">Edit Post</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="block">
                    <div class="block-content block-content-narrow">
                        <form class="form-horizontal push-10-t add-post-form"
                                ...
                                <div class="col-sm-12">
                                    <div class="form-material form-material-primary">
                                        <input class="form-control" type="text" id="post-title"
                                               name="title" placeholder="Post Title" value="{{old('title')?old('title'):$post->title}}" required>
