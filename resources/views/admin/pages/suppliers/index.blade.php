        ...
        <div class="block">
            <div class="block-content">
                <div class="block-header">
                    <h3 class="block-title col-md-6">Active Supplier List</h3>
                                ...
                                <div class="btn-group">
                                    ...
                                    <form class="supplier-inactive"
                                        ...
                                        <button class="btn btn-xs btn-default" type="submit" data-toggle="tooltip"
                                                title="Inactivate Supplier"><i class="fa fa-times"></i></button>
                                    </form>
                                </div>
                            </td>
                        </tr>
...
@section('custom-js')
    ...
    <script>
        jQuery(function () {
            let data = {
                title: 'Are you sure?',
                text: 'To Inactivate This Supplier!!',
